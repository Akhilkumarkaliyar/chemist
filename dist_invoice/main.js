...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.billingproductlist = function (id, loguser, salestype, billno, invodate) {
        return this.http.post(this.baseurl + "billingproductlist", { name: id.name, email: id.email, mobile: id.mobile, address: id.address, addedby: loguser, salestype: salestype, billno: billno, invodate: invodate }, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json"
            })
        });
